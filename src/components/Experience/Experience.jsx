...
const Experience = () => {
  return (
    <>
      <section
        className="
      flex flex-col gap-9 items-center bg-slate-200"
      >
        <h6 className=" bg-gray-300 w-24 rounded text-center">Experience</h6>
        <p>Here is a quick summary of my most recent experiences:</p>
        <div className="flex flex-col gap-20">
          <div className="w-[896px] h-[320px] bg-gray-50 flex  gap-6 pt-[20px] mb-[20px]">
            <img
          ...
          <div className="w-[896px] h-[288px] bg-gray-50 flex  gap-6 pt-[20px]">
            <img
              className="w-[206px] h-[28px]"
              src="./images/Column.png"
              alt=""
          ...
          <div className="w-[896px] h-[180px] bg-gray-50 flex  gap-6 pt-[20px]">
            <img
              className="w-[206px] h-[28px]"
              src="./images/Column.png"
              alt=""
