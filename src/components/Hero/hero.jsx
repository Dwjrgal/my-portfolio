...
const Hero = () => {
  return (
      <section className="flex flex-col-reverse md:flex-row gap-12 items-center min-h-[560px] px-4 md:px-20 dark:bg-gray-950 max-sm:w-[343px]">
        <HeroText />
        <div className="flex items-center pr-[80px]">
          ...
          <motion.img
            className=" object-cover mt-8 h-80 w-80 shadow-md shadow-cyan-800 absolute max-sm:w-[240px] max-sm:h-[280px]"
